...
class VideoPost extends React.Component{
    ...
    constructor(props){
        ...
        this.addVideoComment = this.addVideoComment.bind(this)
        this.changeVideoLike = this.changeVideoLike.bind(this)
    }
            ...
            <div className="main_container">
                ...
                <div className="videoContainer">
                    <video width="800" controls >
                        <source src={getFile(this.state.post.thumbnail)} />
                ...
                <span className='comment_num'>{this.state.comments.length} comments in total</span>
                    ...
                    <div className='comment_button'>
                        <Button variant="contained" color="primary" onClick={this.addVideoComment} disabled={comment_disabled}>Comment</Button>
                    </div>
